...
sablono.util.ToString = (function (){var obj6375 = {};return obj6375;
})();
sablono.util.to_str = (function to_str(x){if((function (){var and__3431__auto__ = x;if(and__3431__auto__)
...
{var x__4070__auto__ = (((x == null))?null:x);return (function (){var or__3443__auto__ = (sablono.util.to_str[goog.typeOf(x__4070__auto__)]);if(or__3443__auto__)
{return or__3443__auto__;
} else
{var or__3443__auto____$1 = (sablono.util.to_str["_"]);if(or__3443__auto____$1)
...
sablono.util.ToURI = (function (){var obj6377 = {};return obj6377;
})();
sablono.util.to_uri = (function to_uri(x){if((function (){var and__3431__auto__ = x;if(and__3431__auto__)
...
{var x__4070__auto__ = (((x == null))?null:x);return (function (){var or__3443__auto__ = (sablono.util.to_uri[goog.typeOf(x__4070__auto__)]);if(or__3443__auto__)
{return or__3443__auto__;
} else
{var or__3443__auto____$1 = (sablono.util.to_uri["_"]);if(or__3443__auto____$1)
{return or__3443__auto____$1;
} else
...
as_str.cljs$lang$applyTo = (function (arglist__6378){
var xs = cljs.core.seq(arglist__6378);
...
{var vec__6380 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__6380,0,null);var words = cljs.core.nthnext.call(null,vec__6380,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__6381_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__6381_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__6381_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__6381_SHARP_))
{return p1__6381_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__6382){
var maps = cljs.core.seq(arglist__6382);
...
{}
var vec__6391 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__6391,0,null);var id = cljs.core.nth.call(null,vec__6391,1,null);var class$ = cljs.core.nth.call(null,vec__6391,2,null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
goog.Uri.prototype.sablono$util$ToString$to_str$arity$1 = (function (x){var x__$1 = this;if(cljs.core.truth_((function (){var or__3443__auto__ = x__$1.hasDomain();if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
